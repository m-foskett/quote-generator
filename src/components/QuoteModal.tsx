  ...
  return (
    ...
    >
        ...
        >
            ...
            {/* Button */}
            <div
                className="h-24 w-72 border-2 border-solid border-primary-950 rounded-3xl mt-5 relative
                duration-300 cursor-pointer top-5 m-auto origin-center bg-primary-700 bg-clip-padding backdrop-filter
                backdrop-blur-sm bg-opacity-10 neon-primary hover:brightness-150 hover:ease-in-out hover:scale-110 hover:origin-center"
                onClick={handleOpenGenerator}
            >
                {/* Button Text */}
                <div
                    className="text-primary-50 text-2xl left-[50%] top-[50%] absolute -translate-x-[50%] -translate-y-[50%]
